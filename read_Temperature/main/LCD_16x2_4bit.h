...
/* ------------------------------------------------------ PIN CONNECTION ------------------------------------------------------- */
sbit LCD_RS = P0^0;		// register select (0 - command, 1 - data) 							
sbit LCD_RW = P0^1; 	// read/write select (0 - write, 1 - read)						
sbit LCD_EN = P0^2; 	// operation (read/write) enable						
sbit LCD_D4 = P0^4;		// higher 4-bit data ...
sbit LCD_D5 = P0^5;
sbit LCD_D6 = P0^6;
sbit LCD_D7 = P0^7;
