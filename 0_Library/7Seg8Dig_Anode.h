...
#define led7seg_numOfDigs 8

// select pin to scan led
#define led7seg_off 0x00
#define led7seg_dig8 0x01
#define led7seg_dig7 (led7seg_dig8 << 1)
#define led7seg_dig6 (led7seg_dig7 << 1)
#define led7seg_dig5 (led7seg_dig6 << 1)
#define led7seg_dig4 (led7seg_dig5 << 1)
